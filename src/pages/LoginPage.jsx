...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-batik-dark">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-batik-dark/95 via-batik-dark/90 to-batik-dark/80 backdrop-blur-[2px]"></div>
      </div>
      ...
      <div className="relative w-full max-w-4xl grid md:grid-cols-2 shadow-2xl rounded-[2rem] overflow-hidden animate-fade-in group">
        ...
        {/* Left Side - Hero */}
        <div className="hidden md:flex flex-col items-center justify-center p-12 bg-gradient-to-br from-batik-gold to-batik-olive text-white relative overflow-hidden">
        ...
        <div className="bg-white/95 backdrop-blur-xl p-8 md:p-12 flex flex-col justify-center relative">
          <div className="absolute top-0 right-0 p-32 bg-batik-gold/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
        
          <div className="mb-8 relative z-10">
             <h2 className="text-3xl font-bold text-batik-dark font-serif mb-2">Selamat Datang</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-batik-gold focus:ring-4 focus:ring-batik-gold/10 outline-none transition-all duration-300 font-medium text-gray-700"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full px-5 py-3.5 pr-12 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-batik-gold focus:ring-4 focus:ring-batik-gold/10 outline-none transition-all duration-300 font-medium text-gray-700"
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-batik-gold transition-colors p-1">
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 accent-batik-gold rounded cursor-pointer" />
                <span className="text-gray-500 group-hover:text-gray-700 transition-colors">Ingat saya</span>
              </label>
              <a href="#" className="text-batik-gold font-semibold hover:underline">Lupa password?</a>
            </div>

            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-batik-gold to-batik-olive text-white rounded-xl font-bold text-sm tracking-wide hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 shadow-batik-gold/20 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed group"
            >
              {loading ? (
